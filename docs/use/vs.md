...
Visual Studio는 기본적으로 [맞춤형 계정](https://docs.microsoft.com/en-us/visualstudio/ide/signing-in-to-visual-studio)을 사용하므로 이미 Visual Studio에 로그인한 경우 이 단계를 건너뛸 수 있습니다. 그렇지 않은 경우 정상적으로 로그인합니다.
...
![VS 도구 옵션 Live Share](../media/vs-tools-options.png)
